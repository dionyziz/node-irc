...
'*******************************************************************************
Public Sub InsertSortStrings(ListArray() As String, _
...
' partition is small
'*******************************************************************************
Public Sub QuickSortStrings(ListArray() As String, _
...
' when finished.
'*******************************************************************************
Public Function QuickSortStringsPartition(ListArray() As String, _
...
'*******************************************************************************
Public Sub MergeSortStrings(ListArray() As String, _
                             ByVal lLowerPoint As Long, _
                             ByVal lUpperPoint As Long, _
                             ByVal lOrder As Long, _
                             ByVal lCompareType As Long)
...
'*******************************************************************************
Public Sub MergeStrings(ListArray() As String, _
                         ByVal lLowerPoint As Long, _
